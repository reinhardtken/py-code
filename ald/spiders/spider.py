        ...
        if fetch_js == False:
          try:
            if post is None:
              ...
              r = s.post(url, post, headers=header, timeout=10, params=param)
          ...
          if currentOS() == 'linux':
            ...
            client = webdriver.PhantomJS(executable_path =PHANTOMJS_PATH, service_args=['--load-images=false', '--disk-cache=true'])
